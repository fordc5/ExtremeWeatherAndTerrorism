...
ui <- bootstrapPage(
  ...
  absolutePanel(top = 10, right = 10,
    sliderInput("range", "Deaths", min(visualizationsAttacks$year), max(visualizationsAttacks$year),
...
server <- function(input, output, session) {
  ...
  filteredData <- reactive({
    visualizationsAttacks[visualizationsAttacks$year >= 
                            input$range[1] & visualizationsAttacks$year <= input$range[2],]
  })
